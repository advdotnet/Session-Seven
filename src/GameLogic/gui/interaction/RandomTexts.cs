...
namespace SessionSeven.GUI.Interaction
{
    public static class RandomTexts
    {
        ...
        public static List<string> Pick = new List<string>()
        {
        ...
        public static List<string> PickInventory = new List<string>()
        {
        ...
        public static List<string> Look = new List<string>()
        {
            GlblRes.I_dont_see_anything_special,
            GlblRes.Nothing_to_see_here
        };

        public static List<string> Talk = new List<string>()
        {
        ...
        public static List<string> Give = new List<string>()
        {
