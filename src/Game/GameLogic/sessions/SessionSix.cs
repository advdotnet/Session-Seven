...
namespace SessionSeven.Cutscenes
{
	...
	public partial class Director : Entity
	{
		...
		private int _sessionSixDialogOneOption;

		public bool KilledLandon => SessionSixDialogOptionOne == _sessionSixDialogOneOption;

		private IEnumerator SessionSixScript()
		{
			RemoveMouseRemains();
			...
			_sessionSixDialogOneOption = firstSelection.ID;
