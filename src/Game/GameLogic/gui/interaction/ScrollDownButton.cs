...
namespace SessionSeven.GUI.Interaction
{
	...
	{
		public static readonly Rectangle ScreenRectangle = new Rectangle(290, Verbs.OFFSET + 17 + 46, 38, 46);
		public static readonly Rectangle TextureRectangle = new Rectangle(290, 17 + 46, 38, 46);
