...
namespace SessionSeven.Basement
{
	...
	{
		protected override Rectangle Hotspot => new Rectangle(649, 79, 49, 26);

		protected override Vector2 InteractionPosition => new Vector2(703, 247);
	}

	[Serializable]
	public class CabinetScrapbooksRight : CabinetScrapbooksBase
	{
		protected override Rectangle Hotspot => new Rectangle(703, 80, 43, 26);
