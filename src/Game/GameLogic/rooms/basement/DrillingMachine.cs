...
namespace SessionSeven.Basement
{
	...
	public class DrillingMachine : Entity
	{
		...
		public bool BiMetalHoleSawInstalled
		{
			...
			set => Get<Sprite>().SetVisible(value);
		}
		...
		private IEnumerator UseSawKitScript()
		{
		...
		private Script UseDrillingMachineWith(InteractionContext context)
		{
			return Game.Ego.StartScript(UseDrillingMachineWithScript(context));
		}

		private IEnumerator UseDrillingMachineWithScript(InteractionContext context)
		{
			Game.Ego.Turn(this);
			using (Game.CutsceneBlock())
			{
