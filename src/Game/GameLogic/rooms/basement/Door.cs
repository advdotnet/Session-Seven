...
namespace SessionSeven.Basement
{
	...
	public class Door : Entity
	{
		...
		private const int _openedFrame = 3;

		public bool Open => Get<Sprite>().Visible && _openedFrame == Get<Sprite>().CurrentFrame;
		...
		private IEnumerator WalkScript()
		{
			yield return Game.Ego.GoTo(this);
		...
		private IEnumerator UseScrewdriverScript()
		{
			yield return Game.Ego.GoTo(this);
			using (Game.CutsceneBlock())
			{
